...
# one-time setup
file_1_folder = 'test_files/test_notes/'
file_2_folder = 'test_files/test_other/'
...
def test_get_midi_length():
    file = MidiFile(file_2_folder + file_2_name + '.mid')
...
def test_open_file():
    file, filename, accuracy = open_file(file_2_folder + file_2_name + '.mid')
...
def test_export_tempo_array():
    tempos = export_tempo_array(file_2_folder + file_2_name + '.mid')

    assert isinstance(tempos, list)
    assert tempos == expected_tempos[:-1]
...
# def test_check_file_type_1_correct():
# def test_check_file_type_1_incorrect():
...
def test_initialise_sequences_booleans_f_mode():
    ...
    file, filename, length, initial_sequences = initialise_sequences(file_2_folder + file_2_name + '.mid',
                                                                     False, False, False)
...
def test_get_sequence_of_notes_booleans_ff_mode_file_1():
    array = np.load(file_1_folder + '/SBFF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', False, False, False)
...
def test_get_sequence_of_notes_booleans_ft_mode_file_1():
    array = np.load(file_1_folder + '/SBFT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', False, False, True)
...
def test_get_sequence_of_notes_booleans_tf_mode_file_1():
    array = np.load(file_1_folder + '/SBTF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', False, True, False)
...
def test_get_sequence_of_notes_booleans_tt_mode_file_1():
    array = np.load(file_1_folder + '/SBTT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', False, True, True)
...
def test_get_sequence_of_notes_velocities_ff_mode_file_1():
    array = np.load(file_1_folder + '/SVFF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', True, False, False)
...
def test_get_sequence_of_notes_velocities_ft_mode_file_1():
    array = np.load(file_1_folder + '/SVFT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', True, False, True)
...
def test_get_sequence_of_notes_velocities_tf_mode_file_1():
    array = np.load(file_1_folder + '/SVTF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', True, True, False)
...
def test_get_sequence_of_notes_velocities_tt_mode_file_1():
    array = np.load(file_1_folder + '/SVTT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_1_folder + file_1_name + '.mid', True, True, True)
...
def test_get_array_of_notes_booleans_f_mode_file_1():
    array = np.load(file_1_folder + '/ABF.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_1_folder + file_1_name + '.mid', False, False)
...
def test_get_array_of_notes_booleans_t_mode_file_1():
    array = np.load(file_1_folder + '/ABT.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_1_folder + file_1_name + '.mid', False, True)
...
def test_get_array_of_notes_velocities_f_mode_file_1():
    array = np.load(file_1_folder + '/AVF.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_1_folder + file_1_name + '.mid', True, False)
...
def test_get_array_of_notes_velocities_t_mode_file_1():
    array = np.load(file_1_folder + '/AVT.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_1_folder + file_1_name + '.mid', True, True)
...
def test_get_sequence_of_notes_booleans_ff_mode_file_2():
    array = np.load(file_2_folder + '/SBFF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', False, False, False)
...
def test_get_sequence_of_notes_booleans_ft_mode_file_2():
    array = np.load(file_2_folder + '/SBFT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', False, False, True)
...
def test_get_sequence_of_notes_booleans_tf_mode_file_2():
    array = np.load(file_2_folder + '/SBTF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', False, True, False)
...
def test_get_sequence_of_notes_booleans_tt_mode_file_2():
    array = np.load(file_2_folder + '/SBTT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', False, True, True)
...
def test_get_sequence_of_notes_velocities_ff_mode_file_2():
    array = np.load(file_2_folder + '/SVFF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', True, False, False)
...
def test_get_sequence_of_notes_velocities_ft_mode_file_2():
    array = np.load(file_2_folder + '/SVFT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', True, False, True)
...
def test_get_sequence_of_notes_velocities_tf_mode_file_2():
    array = np.load(file_2_folder + '/SVTF.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', True, True, False)
...
def test_get_sequence_of_notes_velocities_tt_mode_file_2():
    array = np.load(file_2_folder + '/SVTT.npy', allow_pickle=True)
    out_array = get_sequence_of_notes(file_2_folder + file_2_name + '.mid', True, True, True)
...
def test_get_array_of_notes_booleans_f_mode_file_2():
    array = np.load(file_2_folder + '/ABF.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_2_folder + file_2_name + '.mid', False, False)
...
def test_get_array_of_notes_booleans_t_mode_file_2():
    array = np.load(file_2_folder + '/ABT.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_2_folder + file_2_name + '.mid', False, True)
...
def test_get_array_of_notes_velocities_f_mode_file_2():
    array = np.load(file_2_folder + '/AVF.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_2_folder + file_2_name + '.mid', True, False)
...
def test_get_array_of_notes_velocities_t_mode_file_2():
    array = np.load(file_2_folder + '/AVT.npy', allow_pickle=True)
    out_array = get_array_of_notes(file_2_folder + file_2_name + '.mid', True, True)
